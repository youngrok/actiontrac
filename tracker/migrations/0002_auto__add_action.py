...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Action'
        db.create_table(u'tracker_action', (
            (u'issue_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tracker.Issue'], unique=True, primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_set', to=orm['tracker.Issue'])),
        ))
        db.send_create_signal(u'tracker', ['Action'])


    def backwards(self, orm):
        # Deleting model 'Action'
        db.delete_table(u'tracker_action')
    ...
    models = {
        ...
        u'tracker.action': {
            'Meta': {'object_name': 'Action', '_ormbases': [u'tracker.Issue']},
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_set'", 'to': u"orm['tracker.Issue']"}),
            u'issue_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tracker.Issue']", 'unique': 'True', 'primary_key': 'True'})
        },
